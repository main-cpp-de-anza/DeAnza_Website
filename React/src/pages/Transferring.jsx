  ...
  return (
    <article className="transferring-page">
      ...
      <section id="tag" className="transferring-section">
        ...
        <p>
          <strong>TAG guarantees admission to a participating UC campus</strong> if students
          complete the required courses, maintain the required GPA, and submit their applications on
          time. Students must continue to meet all requirements even after applying.
        </p>
